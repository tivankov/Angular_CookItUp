...
const CARDS: ImageCard[] = [
  ...
  { src: 'https://images.aws.nestle.recipes/original/5b069c3ed2feea79377014f6766fcd49_Original_NTH_Chocolate_Chip_Cookie.jpg', title: 'Chocolate Chip Cookies', category: 'dessert', id: "5" },
  { src: 'https://shop.chudleighs.com/cdn/shop/products/MoltenChocolateLavaCake_086.jpg?v=1616096917', title: 'Chocolate Lava Cakes', category: 'dessert', id: "6" }
];
